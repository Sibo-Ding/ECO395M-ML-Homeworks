...
```{r corr plot, fig.height=8, fig.width=8}
...
I compare the average interests of all categories of two clusters. All interests for cluster 1 are higher than those for cluster 2, meaning users in cluster 1 are more active on Twitter.
```{r kmeans mean}
mkt |>
  group_by(cluster) |>
  summarize_all(mean) |>
