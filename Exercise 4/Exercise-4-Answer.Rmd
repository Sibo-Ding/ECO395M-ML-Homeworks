...
I want to find association rules for customers' groceries shopping basket. That is to find associated groceries that customers are likely to buy, if they buy a grocery. I preprocess the data to fit into "arules" package.  
```{r arules preprocess}
