...
3. The researchers wanted to know whether the decrease in crime was caused by fewer victims on high alert days (as they were scared to go out). Metro ridership captures the number of victims.
