...
From the bar plot, better credit history increases default probability.  
```{r}
loan |>
...
In the logistic regression , compared to `historygood`, `historypoor` decreases default probability, and `historyterrible` further decreases default probability.  
```{r}
# Logistic regression
...
In the bar plot (or the data set), the relationship between default probability and credit history is counter-intuitive. This probably results from the inappropriate sampling process.  
