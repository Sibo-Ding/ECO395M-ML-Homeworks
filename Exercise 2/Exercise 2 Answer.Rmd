...
I split the validation data set into 20 folds, where each fold has about 250 bookings.  
In each fold, I calculate the expected number of bookings with children versus the actual number of bookings with children.  
```{r}
