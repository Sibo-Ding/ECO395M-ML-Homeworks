...
To investigate this case, I plot the predicted probability versus whether a mushroom is poisonous (poisonous = 1). It can be seen the predicted probabilities cluster for two classes.  
```{r}
