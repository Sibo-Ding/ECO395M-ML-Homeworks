...
I am studying at University of Texas at Austin, so my life pattern heavily depends on the school calender. Thus, I create a `semester` variable: it equals to "summer" when `date <= 2023-08-14`, equals to "fall" when `date` in [2023-08-14, 2023-12-11], and equals to "spring" otherwise.  
