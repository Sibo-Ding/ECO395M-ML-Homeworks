...
The first split is workdays (Mon to Thu) vs. weekends (Fri to Sun). I ate mostly at home on weekends. From an information gain perspective, this node is quite pure after only one split.  
...
In spring and fall semesters, going to gym or not distinguished my life pattern. If I went to gym in the fall semester, I would likely eat at canteens. If I did not go to gym on Monday and Wednesday, I would probably eat at home.  
...
Overall accuracy measures the fraction of accurate predictions among outcomes in test data. KNN and CatBoost have the highest accuracy 0.7582.
